...
pack.eager({
  ...
  require('blink.cmp').setup {
    ...
    -- Fuzzy matching remains enabled via blink.cmp's upstream default:
    -- `prefer_rust_with_warning` prefers Rust and warns on Lua fallback.
