...
local keys = {
  ...
  {
    '<leader>gi',
    function() Snacks.gh.issue() end,
    desc = 'GitHub Issues',
  },
  {
    '<leader>gI',
    function() Snacks.gh.issue { state = 'all' } end,
    desc = 'GitHub Issues (All)',
  },
  {
    '<leader>gp',
    function() Snacks.gh.pr() end,
    desc = 'GitHub PRs',
  },
  {
    '<leader>gP',
    function() Snacks.gh.pr { state = 'all' } end,
    desc = 'GitHub PRs (All)',
  },
  -- Grep
  {
...
pack.eager({ pack.gh 'folke/snacks.nvim' }, function()
